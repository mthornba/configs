...
Debian_menu["Debian_Applications_Network_Web_Browsing"] = {
	...
	{"Chrome","/usr/bin/google-chrome-stable","/opt/google/chrome/product_logo_32.xpm"},
	{"Slack","/opt/google/chrome/google-chrome --profile-directory=Default --app-id=jeogkiiogjbmhklcnbgkdcjoioegiknm","/opt/google/chrome/product_logo_32.xpm"},
...
Debian_menu["Debian_Screen_Saving"] = {
	{"Next ScreenSaver (Next)","/usr/bin/xscreensaver-command -next"},
	{"Prev ScreenSaver (Previous)","/usr/bin/xscreensaver-command -prev"},
	{"Random ScreenSaver (Random)","/usr/bin/xscreensaver-command -activate"},
	{"Demo Screen Hacks","/usr/bin/xscreensaver-command -demo"},
	{"Disable XScreenSaver","/usr/bin/xscreensaver-command -exit"},
	{"Enable XScreenSaver","/usr/bin/xscreensaver -no-splash"},
	{"Reinitialize XScreenSaver","/usr/bin/xscreensaver-command -restart"},
	{"Preferences","/usr/bin/xscreensaver-command -prefs"},
}
...
Debian_menu["Debian"] = {
	...
	{ "Ubuntu Control Center", "unity-control-center" },
	{ "Sublime Text", "/usr/local/Sublime Text 2/sublime_text" },
}
